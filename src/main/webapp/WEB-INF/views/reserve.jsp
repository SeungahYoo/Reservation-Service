	...
	<div id="container">
		...
		<div class="ct">
			<div class="ct_wrap">
				...
				<form action="/reservation/api/reserve" method="post" id="reserve_form">
						...
						<div class="ticket_body">
							...
							<div class="qty">
								<div class="count_control">
									...
									<div class="individual_price on_color">
										<span class="total_price">68,000</span><span
											class="price_type">원</span>
									</div>
								</div>
								<div class="qty_info_icon">
							...
							<div class="qty">
								<div class="count_control">
									...
									<div class="individual_price on_color">
										<span class="total_price">60,000</span><span
											class="price_type">원</span>
									</div>
								</div>
								<div class="qty_info_icon">
							...
							<div class="qty">
								<div class="count_control">
									...
									<div class="individual_price on_color">
										<span class="total_price">25,500</span><span
											class="price_type">원</span>
									</div>
								</div>
								<div class="qty_info_icon">
									...
									<div class="inline_form">
										...
										<div class="inline_control">
											<input type="text" name="reservationName" id="name"
												class="text" placeholder="이름" maxlength="17"
												pattern="[^\s]+" title="공백은 입력하실 수 없습니다." required>
										</div>
									</div>
									<div class="inline_form">
										...
										<div class="inline_control tel_wrap">
											<input type="tel" name="reservationTelephone" id="tel"
												class="tel" value="" placeholder="연락처 010-0000-0000"
									...
									<div class="inline_form">
										...
										<div class="inline_control">
											<input type="email" name="reservationEmail" id="email"
												class="email" value="" placeholder="이메일"
