		...
		<div class="ct">
			<div class="ct_wrap">
				<div class="top_title review_header">
					<a href="api/reservation/user-check" class="btn_back"
				...
				<!-- 리뷰 별점 -->
				<form action="/reservation/api/comments" method="post" id="review_form" enctype="multipart/form-data" onsubmit="return isSubmitValid()">
				<input type="hidden" id="reservationInfoId" name="reservationInfoId" value="${param.id }">
					<div class="write_act">
						...
						<div class="review_rating rating_point">
							<div class="rating">
								...
								<span class="star_rank gray_star" id="star_score">0</span>
							</div>
						</div>
					</div>
					<!-- //리뷰 별점 -->
					...
					<div class="review_contents write">
						...
						<a class="review_write_info" > <span class="middot">
					...
					<div class="review_write_footer_wrap">
						<div class="review_write_footer">
							...
							</label> <input type="file" class="hidden_input" name="files"
								id="reviewImageFileOpenInput" accept="image/*" multiple="multiple">
							<div class="guide_review">
								<span id="comment_length">0</span>/400 <span>(최소5자이상)</span>
							</div>
						</div>
					...
					<div class="box_bk_btn">
						<button class="bk_btn" type="submit">
...
<script src="javascript/reviewWrite.js"></script>
